...
"""加载模型"""
model = load_model('D:/fangzhen/ECG/challenge/icbeb/model/base-attention.h5')
model.load_weights('D:/fangzhen/ECG/challenge/icbeb/model/base-weight-attention.h5')
